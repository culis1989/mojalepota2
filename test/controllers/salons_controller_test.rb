...
class SalonsControllerTest < ActionController::TestCase
  ...
  test "should create salon" do
    assert_difference('Salon.count') do
      post :create, salon: { address: @salon.address, description: @salon.description, name: @salon.name }
    end
  ...
  test "should update salon" do
    patch :update, id: @salon, salon: { address: @salon.address, description: @salon.description, name: @salon.name }
    assert_redirected_to salon_path(assigns(:salon))
  end
